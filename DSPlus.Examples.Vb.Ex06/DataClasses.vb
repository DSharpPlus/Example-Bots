...
Public Structure BotGuild
    ...
    Public ReadOnly Property IconUrl As String
        Get
            Return $"{Me.Guild.IconUrl}?size=32"
        End Get
    End Property
...
Public Structure BotMessage
    ...
    Public ReadOnly Property AuthorName As String
        Get
            Return Me.Message.Author.Username
        End Get
    End Property

    Public ReadOnly Property AuthorAvatarUrl As String
        Get
            Return Me.Message.Author.GetAvatarUrl(ImageFormat.Png, 32)
        End Get
    End Property

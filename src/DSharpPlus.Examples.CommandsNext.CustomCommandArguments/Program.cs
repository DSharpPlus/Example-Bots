...
using DSharpPlus.Examples.CommandsNext.CustomCommandArguments.ArgumentConverters;

namespace DSharpPlus.Examples.CommandsNext.CustomCommandArguments
{
    public static class Program
    {
        ...
        public static async Task Main()
        {
            ...
            // Register our argument converters.
            // This is a global registration, so these converters will be used for all commands.
            commandsNext.RegisterConverter(new UlidArgumentConverter());

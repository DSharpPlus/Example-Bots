...
Class Bot
    ...
    Public Interactivity As InteractivityModule
    ...
    Public Async Function MainAsync(args As String()) As Task
        ...
        Dim ICfg As New InteractivityConfiguration()
        With ICfg
        ...
        End With
        Interactivity = Me.Client.UseInteractivity(ICfg)
        ...
        Me.Commands.RegisterCommands(Of ExampleInteractiveCommands)()

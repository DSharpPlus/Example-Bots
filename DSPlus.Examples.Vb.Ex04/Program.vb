...
Imports DSharpPlus.VoiceNext.Codec
...
Class Bot
    ...
    Public Voice As VoiceNextClient
    ...
    Public Async Function MainAsync(args As String()) As Task
        ...
        Me.Commands.RegisterCommands(Of ExampleVoiceCommands)()

        ' let's set up voice
        Dim VCfg As New VoiceNextConfiguration()
        With VCfg
            .VoiceApplication = VoiceApplication.Music
        End With

        ' and let's enabled it
        Me.Voice = Me.Client.UseVoiceNext(VCfg)
